...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head><title>Anular Coseguro Ordenes de Auditoría</title>
        ...
        <script>
            ...
            function ProcesarRecalculo(){
                ...
                if (ValidarFecha(desde) & ValidarFecha(hasta)) {
                    if (confirm('¿ Seguro para Suprimir Monto en Determinaciones en el Período ' + desde + ' - ' + hasta +  ' ?' )) {
                        ajax=objetoAjax();
                        //uso del medoto GET
                        ...
                        ajax.open('GET', './operaciones/recalcular_montos_scos.php?desde='+desde+'&hasta='+hasta+'&aleatorio='+aleatorio+'&codos='+codos);
        ...
        <form name="frmRecalcular" method="post" onsubmit="return false">
            ...
            <div style="margin:auto;width:550px;text-align:center;">
                ...
                <table width="550px" border="0" align="center">
                    <tr>
                        <td width="110px" align="left">Suprimir Coseguros</td>
