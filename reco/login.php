    ...
    <head>
        ...
        <script>
            ...
            function VerificarLogin(usuario, pass){
                ...
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        ...
                        if (contenido.indexOf('- Auditor No Autorizado') > -1) {
                            cargar = false;
                        }
                    }
            ...
            function CargarModulo(usuario) {
                var aleatorio = Math.random();
                var host = location.protocol + '//' + location.hostname + '/' + document.getElementById('ruta').value + '/newhtml_menu.php?aleatorio='+aleatorio+'&p111989='+usuario;
