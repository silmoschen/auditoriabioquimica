        ...
        <script>
            ...
            function DepurarLogs(){
                ...
                if (confirm('¿ Seguro para Depurar Logs en el Período ' + desde + ' - ' + hasta + ' ?' )) {
                    ...
                    ajax.open('GET', './operaciones/procesar_depuracion_logs_wsres.php?desde='+desde+'&hasta='+hasta+'&aleatorio='+aleatorio);
            ...
            function getHistorial() {
                ...
                divResult = document.getElementById('Rs');
                
                ajax1=objetoAjax();
                ajax1.open('GET', './operaciones/depurar_logsws_list.php');
