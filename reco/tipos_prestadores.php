...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Tabla de Prestadores</title>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja){
                ...
                ajax.open('GET', './operaciones/paginador_tipos_prestadores.php?pag='+nropagina+'&filtro='+filtro+'&edbaja='+edbaja+'&aleatorio='+aleatorio);
            ...
            function Nuevo(){
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax.open('GET', './operaciones/editar_tipo_prestador.php?aleatorio='+aleatorio+'&modo=1');
            ...
            function Registrar(codigo, descrip,  modo){
                ...
                //registro.php
                if (modo == 1) {
                    ajax1.open("GET", "./operaciones/registro_tipo_prestador.php?codigo="+codigo+"&descrip="+descrip+'&modo=1'+'&aleatorio='+aleatorio,true);
                }
                if (modo == 2) {
                    ajax1.open("GET", "./operaciones/registro_tipo_prestador.php?codigo="+codigo+"&descrip="+descrip+'&modo=2'+'&aleatorio='+aleatorio,true);
                }
            ...
            function EditarRegistro(codigo) {
                ...
                ajax.open('GET', './operaciones/editar_tipo_prestador.php?id='+codigo+'&aleatorio='+aleatorio+'&modo=2', true);
            ...
            function Borrar(codigo) {
                ...
                ajax.open('GET', './operaciones/BorraTipoPrestador.php?id='+codigo+'&aleatorio='+aleatorio, true);
            ...
            function ProcederBaja(codigo) {
                var aleatorio = Math.random();
                divBorrar = document.getElementById('borrar');
                ajax.open('GET', './operaciones/baja_tipo_prestador.php?codigo='+codigo+'&aleatorio='+aleatorio, true);
        ...
        <div style="margin:auto;width:550px;text-align:center;">
            ...
            <table border="0px">
                <tr>
                    ...
                    <td width="400px" align = "left"><b>Tipo de Prestador</b></td>

                </tr>
            </table>

            <div id="contenido">
                <?php include('operaciones/paginador_tipos_prestadores.php') ?>
            </div>
