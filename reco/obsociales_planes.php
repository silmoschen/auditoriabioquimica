    ...
    <head>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja){
                ...
                ajax.open('GET', './operaciones/paginador_obsocial_planes.php?pag='+nropagina+'&filtro='+filtro+'&edbaja='+edbaja+'&aleatorio='+aleatorio+'&codos='+codos);
            ...
            function Nuevo(){
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax.open('GET', './operaciones/editar_obsocial_plan.php?aleatorio='+aleatorio+'&modo=1');
            ...
            function Registrar(id, descrip, codigo1, codigo2, modo){
                var codos = document.getElementById('listObsocial').value;
                if (codos.length == 0) {
                ...
                //registro.php
                if (modo == 1) {
                    ajax1.open("GET", './operaciones/registro_obsocial_plan.php?id='+id+'&descrip='+descrip+'&aleatorio='+aleatorio+'&codos='+codos+'&codigo1='+codigo1+'&codigo2='+codigo2, true);
                }
                if (modo == 2) {
                    ajax1.open("GET", './operaciones/actualizo_obsocial_plan.php?id='+id+'&descrip='+descrip+'&aleatorio='+aleatorio+'&codos='+codos+'&codigo1='+codigo1+'&codigo2='+codigo2, true);
                }
            ...
            function EditarRegistro(id) {
                ...
                ajax.open('GET', './operaciones/editar_obsocial_plan.php?id='+id+'&aleatorio='+aleatorio+'&modo=2&codos='+codos, true);
            ...
            function Borrar(id) {                
                ...
                ajax.open('GET', './operaciones/BorraObsocialPlanes.php?id='+id+'&codos='+codos, true);
            ...
            function ProcederBaja(id) {
                ...
                var codos = document.getElementById('listObsocial').value;
                divBorrar = document.getElementById('borrar');
                ajax.open('GET', './operaciones/baja_obsocial_plan.php?id='+id+'&aleatorio='+aleatorio+'&codos='+codos, true);
    ...
    <body>
        ...
        <div style="margin:auto;width:550px;text-align:center;">
            ...
            <div id="botones">
                <?
                echo "<FIELDSET>";
                echo "<LEGEND>Mantenimiento Planes Obras Sociales</LEGEND>";
            ...
            <table border="0px" width="500px">
                <tr>
                    ...
                    <td width="200px" align = "left"><b>Descripción Plan</b></td>
                    <td width="70px" align = "left"><b>Cant. Afiliados</b></td>                    
                    <td width="30px" align = "left"><b>Cod.Export.</b></td>                    
                    <td width="30px" align = "left"><b>Cod.Import.</b></td>                   
