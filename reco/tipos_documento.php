...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja){
                ...
                ajax.open('GET', './operaciones/paginador_tipodoc.php?pag='+nropagina+'&filtro='+filtro+'&edbaja='+edbaja+'&aleatorio='+aleatorio);
            ...
            function Nuevo(){
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax.open('GET', './operaciones/editar_tipodoc.php?aleatorio='+aleatorio+'&modo=1');
            ...
            function ValidarNroint(e, xdescrip) {
                e= (window.event)? event : e;
                intKey = (e.keyCode)? e.keyCode: e.charCode;
                if (intKey == 13) {
                    if (xdescrip.length == 0) {
                        alert('Número de Comprobante Interno Incorrecto ...!');
                        return false;
                    }
                    return true;
                }
            ...
            function Registrar(codigo, descrip, nroint,  modo){
                if (codigo.length == 0) {
                ...
                if (nroint.length == 0) {
                    alert('Número Interno Incorrecto ...!');
                    return false;
                }
                ...
                //registro.php
                if (modo == 1) {
                    ajax1.open("GET", "./operaciones/registro_tipodoc.php?codigo="+codigo+"&descrip="+descrip+'&nroint='+nroint+'&modo=1'+'&aleatorio='+aleatorio,true);
                }
                if (modo == 2) {
                    ajax1.open("GET", "./operaciones/registro_tipodoc.php?codigo="+codigo+"&descrip="+descrip+'&nroint='+nroint+'&modo=2'+'&aleatorio='+aleatorio,true);
                }
            ...
            function EditarRegistro(codigo) {
                ...
                ajax.open('GET', './operaciones/editar_tipodoc.php?id='+codigo+'&aleatorio='+aleatorio+'&modo=2', true);
            ...
            function LimpiarCampos(){
                ...
                document.getElementById('nroint').value="";
            }
            ...
            function Borrar(codigo) {
                ...
                ajax.open('GET', './operaciones/BorraTipoDoc.php?id='+codigo+'&aleatorio='+aleatorio, true);
            ...
            function ProcederBaja(codigo) {
                var aleatorio = Math.random();
                divBorrar = document.getElementById('borrar');
                ajax.open('GET', './operaciones/baja_tipodoc.php?codigo='+codigo+'&aleatorio='+aleatorio, true);
    ...
    <body>
        ...
        <div style="margin:auto;width:550px;text-align:center;">
            ...
            <table border="0px">
                <tr>
                    <td width="20px"><b>Cód.</b></td>
                    <td width="350px" align = "left"><b>Descripción</b></td>
                    <td width="30px"><b>Nro.Int.</b></td>

                </tr>
            </table>

            <div id="contenido">
                <?php include('operaciones/paginador_tipodoc.php') ?>
            </div>
