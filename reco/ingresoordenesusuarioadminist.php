...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <head><title>Ingreso Ordenes de Auditoria</title>
        ...
        <script>
            ...
            function Init() {
                document.getElementById('listEfectores').focus();
                return true;
            }
            ...
            function CargarDocumento(xcodos, xnrodoc) {
                ...
                var usuario = document.getElementById('listEfectores').value;

                // verificar si la validación es remota                
                if (document.getElementById('a_rpc').value == 'S' || document.getElementById('a_rpc').value == 'M') {
                    //ajaxp0.open('GET', './operaciones/alta_paciente_rpc.php?codos=' + xcodos + '&nrodoc=' + xnrodoc + '&aleatorio=' + aleatorio + '&idprof=' + usuario, true);
                    ...
                    ajaxp0.onreadystatechange = function () {
                        if (ajaxp0.readyState == 4) {
                            ...
                            var c = contenido;
                            //document.getElementById('nrodoc').value = contenido;
            ...
            function ArchivarOrden(xcodigos, medicocab) {
                ...
                var nrotrans = usuario + f + LlenarIzquierda(allTrim(nrodoc), 9, '0') + document.frmOrden.nrotrans.value;
                ...
                if (_l > 9) {
                    ...
                    nrotrans = usuario + f + _t + document.frmOrden.nrotrans.value;
                }
            ...
            <div style="margin:auto;width:550px;text-align:center;">
                ...
                <div id="carga">
                    ...
                    <div id='divtrack'>
                        <table width="500px" border="0" align="center">
                            <tr>
                                <td width="67px" align="right">Track o Token:</td>
                    ...
                    <table width="500px" border="0" align="center">
                        <tr>
                            ...
                            <td align="left">
                                <input name="nombremedico" id="nombremedico" type="text" style="font-size: 10px;" maxlength="40" width="15" size="44" disabled="true" onkeypress="javascript: if (ValidarNombreMedico(event, nombremedico.value)) {
                                            listMedicos.focus();
                                            return true;
                                        }" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <td align="right">Fecha:
                                    <td width="70px" align="left">
                                        <?
                                        echo '<input name="fecha" type="text" disabled="disabled" id="fecha" style="font-size: 10px;" tabindex="2" size="10" maxlength="10" readonly="true" value="' . $u->getFechaActual() . '"/>';
