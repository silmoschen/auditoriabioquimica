    ...
    <head><title>Autorización de Ordenes de Auditoria</title>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja, xtipo_consulta) {
                ...
                ajax1.open('GET', './operaciones/paginador_autorizacion_auditoria.php?pag=' + nropagina + '&filtro=' + filtro + '&edbaja=' + edbaja + '&idprof=' + idprof + '&desde=' + desde + '&hasta=' + hasta + '&tipo_consulta=' + xtipo_consulta + '&aleatorio=' + aleatorio + '&codos=' + codos);
            ...
            function MostrarOrden(xnroauditoria) {
                ...
                ajax3.open('GET', './operaciones/AutorizarOrden.php?nrotrans=' + xnroauditoria + '&aleatorio=' + aleatorio);                
            ...
            function btnadd1(xcodigo, xnroauditoria, xnroautorizacion) {
                
                if (xnroautorizacion == null || xnroautorizacion == '') {
                  alert('Número de Expediente Incorrecto ...!');
                  return false;
                }
                ...
                ajaxcod.onreadystatechange = function () {
                    if (ajaxcod.readyState == 4) {
                        ...
                        if (confirm('¿ Seguro para Agregar Práctica ' + xcodigo + ' - ' + contenido + ' en Orden: ' + xnroauditoria + ' ?')) {
                            addPractica(xnroauditoria, xcodigo, xnroautorizacion);
                        }
                    }                  
            ...
            function addPractica(xnroauditoria, xcodigo, xnroautorizacion) {
                var aleatorio = Math.random();
                divError = document.getElementById('err');
                ajaxcod1 = objetoAjax();
                ajaxcod1.open('GET', './operaciones/auditoria_add_practica.php?codigo=' + xcodigo + '&nroauditoria=' + xnroauditoria + '&nroautorizacion=' + xnroautorizacion + '&aleatorio=' + aleatorio);
            ...
            function ValidarForm4(e, expediente, xnroauditoria) {
                e = (window.event) ? event : e;
                intKey = (e.keyCode) ? e.keyCode : e.charCode;
                if (intKey == 13) {
                    if (expediente.length > 0) {
                        ...
                        var ajax3 = objetoAjax();
                        divVerOrden.innerHTML = '<img src="anim.gif"> :: Validando Orden ...';
                        ajax3.open('GET', './operaciones/AutorizarOrdenRegla5.php?nrotrans=' + xnroauditoria + '&expediente=' + expediente + '&aleatorio=' + aleatorio);
                        ajax3.onreadystatechange = function () {
                            if (ajax3.readyState == 4) {
                                //mostrar resultados en esta capa
                                divVerOrden.innerHTML = ajax3.responseText
        ...
        <form name="frmConsulta" method="post" onsubmit="return false">
            ...
            <table width="550px" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="200px" align = "left">
                        <?
                        include('operaciones/lista_os_topeanual.php');
                        ?>
                    </td>
