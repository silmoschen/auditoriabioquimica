        ...
        <script>
            ...
            function AgregarCodigo() {                
                ...
                if (codos.length > 0) {
                    ...
                    if(codos.length == 6 && codigo.length == 6) {
                        ...
                        ajax=objetoAjax();
                        ajax.open('GET', './operaciones/alta_codigo_diferido.php?codos='+codos+'&codigo='+codigo+'&aleatorio='+aleatorio);
            ...
            function ListarItems()  {
                ...
                if (codos.length > 0) {
                    ...
                    divLista = document.getElementById('Lista');
                    ajax=objetoAjax();
                    ajax.open('GET', './operaciones/lista_codigos_diferidos.php?codos='+codos+'&aleatorio='+aleatorio);
                    ajax.onreadystatechange=function() {
                        if (ajax.readyState==4) {
                            //mostrar resultados en esta capa
                            divLista.innerHTML = ajax.responseText
            ...
            function BajaCodigo(codos, codigo){
                ...
                ajax.open('GET', './operaciones/BorraCodigoDiferido.php?codos='+codos+'&codigo='+codigo+'&aleatorio='+aleatorio);
            ...
            function ProcederBaja(codos, codigo){
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax1.open('GET', './operaciones/baja_codigo_diferido.php?codos='+codos+'&codigo='+codigo+'&aleatorio='+aleatorio);
                divBorra.innerHTML= '<img src="anim.gif"> :: Eliminando ...';
                ajax1.onreadystatechange=function() {
                    if (ajax1.readyState==4) {
                        //mostrar resultados en esta capa
                        //divBorra.innerHTML = '';
                        //alert('./operaciones/baja_codigo_diferido.php?codos='+codos+'&codigo='+codigo+'&aleatorio='+aleatorio); 
                        ListarItems();
                    }                    
                }
                ajax1.send(null)
