...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head><title>Listado Coseguros Profesionales</title>
        ...
        <script>
            ...
            function GenerarCuadro() {
                ...
                if (ValidarFecha(desde) && ValidarFecha(hasta)) {
                    ...
                    var ajax = objetoAjax();
                    divMensaje.innerHTML = '<img src="anim.gif"> :: Generando Reporte, Espere por favor';
                    ajax.open('GET', './operaciones/generar_coseguros_profesional.php?desde=' + desde + '&hasta=' + hasta + '&porcentaje=' + porcentaje + '&aleatorio=' + aleatorio + '&regla=' + regla);
            ...
            function CancelarImpresion() {
                divInf = document.getElementById('Resultado');
                divInf.innerHTML = '';
        ...
        <form name="frmExportarOrdenes" method="post" onsubmit="return false">
            ...
            <div style="margin:auto;width:550px;text-align:center;">
                ...
                <table width="550px" border="0" align="center">
                    <tr>
                        <td width="140px" align="left">Coseguro Obras Sociales</td>
                ...
                <table width="426" border="0" align="center">                  
                    ...
                    <tr>
                        ...
                        <td width="70">Porcentaje Cos.:</td>
                        <td width="100px">
                            <input name="porcentaje" id="porcentaje" value="6" type="text" maxlength="2" width="2" size="2" style="font-size: 10px;" />                           
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="200px" align="left">                            
                            <a href="javascript://" onclick="GenerarCuadro()">Generar Reporte</a>
                        </td>
                        <td width="70px">
                        </td>
                        <td width="100px"></td>
