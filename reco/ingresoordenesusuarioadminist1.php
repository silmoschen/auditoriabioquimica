        ...
        <script>
            ...
            function MostrarBotonesImpresion() {
                ...
                ajax4.onreadystatechange=function() {
                    ...
                    document.frmOrden.btnCancelarImpresion.focus();
                }
                ajax4.send(null);
            }
            ...
            function Reiniciar(tipo_reinicio) {
                if (tipo_reinicio.substr(0, 1) == 'ANULADO') {
                    // Vuelve al menu
                    var aleatorio = Math.random();
                    link = '?p111989=' + document.getElementById('usuario').value + '&susuaurio=' + document.getElementById('usuario').value + '&reinit=' + aleatorio;
                    var host = location.protocol + '//' + location.hostname + '/menu_admin.php' + link;
                    window.location.href = host;
                }
                
                if (tipo_reinicio.substr(0, 1) == 'I' || tipo_reinicio.substr(0, 1) == 'R') {
                    // Reinicia el Form
                    var aleatorio = '"' +  Math.random() + '"';
                ...
                <div id="carga">
                    ...
                    <table width="500px" border="0" align="center">
                        <tr>
                            ...
                            <td width="70px" align="left">
                                <?
                                echo '<input name="fecha" type="text" id="fecha" style="font-size: 10px;" tabindex="2" size="10" maxlength="10" onkeypress="javascript: if(ValidarFechaOrden(event, fecha.value)) {listPerfil.focus()}; return true" /> ';
