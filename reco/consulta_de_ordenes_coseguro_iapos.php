    ...
    <head><title>Consulta de Ordenes de Auditoría</title>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja, xtipo_consulta, nrodoc) {
                ...
                ajax.open('GET', './operaciones/paginador_consulta_auditoria_cos.php?pag=' + nropagina + '&filtro=' + filtro + '&edbaja=' + edbaja + '&idprof=' + idprof + '&desde=' + desde + '&hasta=' + hasta + '&tipo_consulta=' + xtipo_consulta + '&aleatorio=' + aleatorio + '&codos=' + codos + '&nrodoc=' + nrodoc + '&profesional="S"');
            ...
            function MostrarOrden(xnroauditoria) {
                document.getElementById('mensajebono').innerHTML = '';
                //donde se mostrar los registros
                var aleatorio = Math.random();
                divVerOrden = document.getElementById('ListarOrden');
                hidediv("Lista");
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax3.open('GET', './operaciones/listar_hoja_orden_coseguro_iapos.php?nrotrans=' + xnroauditoria + '&aleatorio=' + aleatorio);
                ajax3.onreadystatechange = function () {
                    if (ajax3.readyState == 4) {
                        //mostrar resultados en esta capa
                        divVerOrden.innerHTML = ajax3.responseText
                    }
                    AplicarCoseguro(xnroauditoria);
            ...
            function AplicarCoseguro(xnroauditoria) {
                //donde se mostrar los registros
                var aleatorio = Math.random();

                divCoseguro = document.getElementById('divcoseguro');

                ajax10 = objetoAjax();
                //uso del medoto GET
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax10.open('GET', './operaciones/aplicar_coseguro_iapos.php?nrotrans=' + xnroauditoria + '&aleatorio=' + aleatorio);
                ajax10.onreadystatechange = function () {
                    if (ajax10.readyState == 4) {
                        //mostrar resultados en esta capa
                        divCoseguro.innerHTML = ajax10.responseText
                    }
                }
                ajax10.send(null)
            }
            ...
            function selectCos(opt) {
                if (opt == 1)
                    document.getElementById('nroTx').disabled = true;
                if (opt == 2)
                    document.getElementById('nroTx').disabled = false;
            }

            function aplicarCoseguro(opt, nroauditoria) {

                if (opt == 1) {
                    if (confirm('Seguro para Aplicar Bono Impreso IAPOS a Orden Nro. ' + nroauditoria) == true) {
                        procesarBonoImpreso(nroauditoria);

                    }
                }

                if (opt == 2) {
                    if (confirm('Seguro para Aplicar Bono Billetera Santa Fe IAPOS a Orden Nro. ' + nroauditoria) == true) {
                        var nroTx = document.getElementById('nroTx').value;

                        if (nroTx == '') {
                            alert('El Número de Transacción es Obligatorio ...');
                            return;
                        }

                        procesarBonoBilletera(nroauditoria, nroTx);
                    }
                }
            }

            function anularCoseguro(opt, nroauditoria) {

                if (opt == 1) {
                    if (confirm('Seguro para Anular Bono Impreso IAPOS a Orden Nro. ' + nroauditoria) == true) {
                        anularBonoImpreso(nroauditoria);
                ...
                if (opt == 2) {
                    if (confirm('Seguro para Aplicar Bono Billetera Santa Fe IAPOS a Orden Nro. ' + nroauditoria) == true) {
                        anularBonoBilletera(nroauditoria);
                    }
                }
            }
            ...
            function procesarBonoImpreso(nroauditoria) {

                var aleatorio = Math.random();
                divMC = document.getElementById('mensajebono');

                ajax5 = objetoAjax();
                ajax5.open('GET', './operaciones/aplicar_bono_iapos_impreso.php?nroauditoria=' + nroauditoria + '&aleatorio=' + aleatorio);
                ajax5.onreadystatechange = function () {
                    if (ajax5.readyState == 4) {
                        //mostrar resultados en esta capa
                        divMC.innerHTML = ajax5.responseText;
                        cancelarCoseguro();
                    }
                }
            ...
            function procesarBonoBilletera(nroauditoria, nroTx) {

                var aleatorio = Math.random();
                divMC = document.getElementById('mensajebono');

                ajax5 = objetoAjax();
                ajax5.open('GET', './operaciones/aplicar_bono_iapos_billetera.php?nroauditoria=' + nroauditoria + '&nrotrans=' + nroTx + '&aleatorio=' + aleatorio);
                ajax5.onreadystatechange = function () {
                    if (ajax5.readyState == 4) {
                        //mostrar resultados en esta capa
                        divMC.innerHTML = ajax5.responseText;
            ...
            function anularBonoImpreso(nroauditoria) {

                var aleatorio = Math.random();
                divMC = document.getElementById('mensajebono');

                ajax5 = objetoAjax();
                ajax5.open('GET', './operaciones/aplicar_bono_iapos_impreso.php?nroauditoria=' + nroauditoria + '&anula=S' + '&aleatorio=' + aleatorio);
                ajax5.onreadystatechange = function () {
                    if (ajax5.readyState == 4) {
                        //mostrar resultados en esta capa
                        divMC.innerHTML = ajax5.responseText;
            ...
            function anularBonoBilletera(nroauditoria) {

                var aleatorio = Math.random();
                divMC = document.getElementById('mensajebono');

                ajax5 = objetoAjax();
                ajax5.open('GET', './operaciones/aplicar_bono_iapos_billetera.php?nroauditoria=' + nroauditoria + '&anula=S' + '&aleatorio=' + aleatorio);
                ajax5.onreadystatechange = function () {
                    if (ajax5.readyState == 4) {
                        //mostrar resultados en esta capa
                        divMC.innerHTML = ajax5.responseText;
            ...
            function cancelarCoseguro() {
                ConsultarOrdenes(3);

                var ajax33 = objetoAjax();
                divBuscar = document.getElementById('divcoseguro');
                divBuscar.innerHTML = '';
                ajax33.send(null);
            }
    ...
    <body>
        ...
        <form name="frmConsulta" method="post" onsubmit="return false">
            ...
            <div style="margin:auto;width:550px;text-align:center;">
                ...
                <div id="divcoseguro" align="center">
                </div>

                <div id="mensajebono" align="center">
                </div>
