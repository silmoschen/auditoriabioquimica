    ...
    <head><title>Consulta de Ordenes de Auditoría</title>
        ...
        <script>
            ...
            function Pagina(nropagina, filtro, edbaja, xtipo_consulta, nrodoc){
                ...
                ajax.open('GET', './operaciones/paginador_consulta_auditoria.php?pag='+nropagina+'&filtro='+filtro+'&edbaja='+edbaja+'&idprof='+idprof+'&desde='+desde+'&hasta='+hasta+'&tipo_consulta='+xtipo_consulta+'&aleatorio='+aleatorio+'&codos='+codos+'&nrodoc='+nrodoc);
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        //mostrar resultados en esta capa
