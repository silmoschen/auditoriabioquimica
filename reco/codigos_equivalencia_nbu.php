    ...
    <head><title>Equivalencia de Códigos NBU</title>
        ...
        <script>
            ...
            function VerificarCodigo(xcodigo, modo) {
                ...
                ajaxcod = objetoAjax();
                ajaxcod.open('GET', './operaciones/verificar_codigo_nbu_st.php?codigo=' + xcodigo + '&aleatorio=' + aleatorio);
            ...
            function AgregarCodigo() {
                ...
                if (codos.length > 0) {
                    ...
                    if (codos.length == 6 && codigo1.length == 6 & codigo2.length == 6) {
                        ...
                        ajax = objetoAjax();
                        ajax.open('GET', './operaciones/insertar_codigo_equivalente_nbu.php?codos=' + codos + '&codigo1=' + codigo1 + '&codigo2=' + codigo2 + '&aleatorio=' + aleatorio + '&prefijo=' + prefijo);
            ...
            function ListarItems() {
                ...
                if (codos.length > 0) {
                    ...
                    divLista = document.getElementById('Lista');
                    ajax = objetoAjax();
                    ajax.open('GET', './operaciones/lista_codigos_equivalentes_nbu.php?codos=' + codos + '&codigo=' + codigo + '&aleatorio=' + aleatorio);
                    ajax.onreadystatechange = function () {
                        if (ajax.readyState == 4) {
                            //mostrar resultados en esta capa
                            divLista.innerHTML = ajax.responseText
            ...
            function ValidarPrefijo(e, xcodigo) {
                e = (window.event) ? event : e;
                intKey = (e.keyCode) ? e.keyCode : e.charCode;
                if (intKey == 13) {
                    return true;
            ...
            function ProcederBaja(codos, codigo1) {
                ...
                //indicamos el archivo que realizar� el proceso de paginar
                //junto con un valor que representa el nro de pagina
                ajax1.open('GET', './operaciones/baja_codigo_equivalente_nbu.php?codos=' + codos + '&codigo1=' + codigo1 + '&aleatorio=' + aleatorio);
                ...
                <FIELDSET>
                    ...
                    <table width="500px" border="0" align="center">
                        ...
                        <tr>
                            ...
                            <td align = "left">
                                <input name="codigo1" id="codigo1" type="text" style="font-size: 10px;" maxlength="6" width="2" size="6" onKeyPress="javascript: ValidarCodigo1(event, codigo1.value);"                                                                               
                                         />                            
                            </td>
                        ...
                        <tr>
                            <td width="87" align = "right">Prefijo:</td>
                            <td align = "left">
                                <input name="prefijo" id="prefijo" type="text" style="font-size: 10px;" maxlength="6" width="2" size="6" onKeyPress="javascript: if (ValidarPrefijo(event, prefijo.value)) {
                                            codigo2.focus()}; return true" />                            </td>
                            <td colspan="3" align = "left">
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="50" align = "left">
                                <input name="codigo2" id="codigo2" type="text" style="font-size: 10px;" maxlength="6" disabled = "true" width="2" size="6" onKeyPress="javascript: if (ValidarCodigo2(event, codigo2.value)) {
                                            codigo2.focus()
                                        }
                                        ;
                                        return true" />
