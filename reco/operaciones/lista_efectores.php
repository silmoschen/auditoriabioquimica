...
<select name="listEfectores" id="listEfectores"  style="width:300px" onchange="javascript: if(CambiarOS()) {desde.focus()}" onkeypress="javascript: if(ControlEfector(event)) {listEfectores.focus()}; return true">
  <?php
