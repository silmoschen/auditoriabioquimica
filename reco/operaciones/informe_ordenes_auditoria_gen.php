...
$Resultado= $auditoria->getConsultaOrdenesPorEstado($codos, $idprof, $desde, $hasta, $opcion, 0, 1000);

echo '<hr>';
if ($opcion == 1) {
  echo "<h4>Listado de Ordenes con Aut. Directa entre el $desde y $hasta </h4>";
}
if ($opcion == 2) {
  echo "<h4>Listado de Ordenes con Aut. Diferida entre el $desde y $hasta </h4>";
}
echo '<hr>';
...
echo "<p align='center'><b>$cantidad Registros Listados</b></p>";
