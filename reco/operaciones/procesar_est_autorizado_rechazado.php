...
echo '<table width = "500px" align="center">';
echo '<tr>';
echo '<td width="70px">Código</td>';
echo '<td width="40px" align="right">Cant.</td>';
...
while($fila=mysql_fetch_array($resultado)){
    ...
    if ($cant > 0) {
        ...
        // Verificamos nomenclador diferencial - 31/07/2026
        if ($vn == 'true') {        
            $unidad = $nbu->getUnidadObsocial($codos);
        }        
        
        echo '<tr>';
        echo '<td width="70px">' . $fila['codigo'] . '</td>';
        echo '<td width="40px" align="right">' . $cant . '</td>';
...
echo '<table width = "500px" align="center">';
echo '<tr>';
echo '<td width="80px">Total OS.:</td>';
...
echo '<table width = "500px" align="center">';
echo '<tr>';
echo '<td width="80px">Cant. Ordenes</td>';
...
echo '<table width = "500px" align="center">';
echo '<tr>';
echo '<td width="80px">Cant. Pacientes</td>';
