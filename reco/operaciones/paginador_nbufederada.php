...
while ($MostrarFila = mysql_fetch_array($Resultado)) {
    $r = $nnbu->getObject($MostrarFila['codigo']);
    $descrip = " *** No Definida ***";
    if ($r != null) $descrip = $nnbu->getDescrip();
    echo "<tbody align = 'left'>";
    echo "<tr>";
    echo "<td width='30px'>" . $MostrarFila['codigo'] . "</td>";
    echo "<td width='500px'>" . $descrip . "</td>";
    echo "<td width='50px'>" . $MostrarFila['nivel'] . "</td>";
    echo "<td width='50px'>" . $MostrarFila['tope_anual'] . "</td>";
