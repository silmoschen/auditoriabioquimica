...
<select name="listObsocial1" id="listObsocial1" width="80" style="width:250px" onchange="javascript: if(CambiarOS()) {list_os_padrones2.focus()}" onclick="javascript: if(CambiarOSS1()) {btnRegistrar.focus()}; return true;">
