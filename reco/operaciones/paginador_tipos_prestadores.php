...
//$dir = str_replace("/operaciones/paginador_efector.php", "", __FILE__);
//$dir = str_replace("\operaciones\paginador_efector.php", "", __FILE__);
//include_once($dir . '/classes/cEfector.php');
...
$Resultado = $tp->getTipoPrestadores($filtro, $RegistrosAEmpezar, $RegistrosAMostrar);

echo "<table border='0px'>";
while ($MostrarFila = mysql_fetch_array($Resultado)) {
    echo "<tbody align = 'left'>";
    echo "<tr>";
    echo "<td width='30px'>" . $MostrarFila['id'] . "</td>";
    echo "<td width='400px'>" . $MostrarFila['descrip'] . "</td>";
...
$NroRegistros = mysql_num_rows($tp->getTipoPrestadores($filtro, 0, 1000000));
