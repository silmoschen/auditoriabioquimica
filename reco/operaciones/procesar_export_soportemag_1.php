        ...
        while ($it = mysql_fetch_array($determinaciones)) {
            ...
            if ($it['estado'] == 'A') {
                ...
                if ($cod != '') {
                    ...
                    $exportar->addDPM('REL_PRACTICASREALIZADASXAMBULATORIO', $linea, $nroauditoria, $afiliado->getTipo_doc(), $nrodoc, $cod, $afiliado->getId_beneficio(), $monto);
                }
            }
        }
...
if ($procesoOK) {
    ...
    echo '<a href="javascript://" onclick="GenerarCantidadDeterminaciones()">Generar Archivo de Determinaciones Procesadas</a>';
} else {
