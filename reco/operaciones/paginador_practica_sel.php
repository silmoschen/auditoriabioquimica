...
$Resultado = $nbu->getListaPracticas($filtro, $RegistrosAEmpezar, $RegistrosAMostrar);

echo "<table border='0px'>";
while($MostrarFila=mysql_fetch_array($Resultado)){
    echo "<tbody align = 'left'>";
    echo "<tr>";
    echo "<td width='30px'>".$MostrarFila['vch_codprestacion']."</td>";
    echo "<td width='500px'>".$MostrarFila['vch_descripprestacion']."</td>";
    $seleccion = "CodigoNBUSel("."'".$MostrarFila['vch_codprestacion']."'".")";
