...
$resultado = $obj->getOrdenesAfiliadoProfesional($codos, $idprof);
...
while($f = mysql_fetch_array($resultado)){
  if ($f['anulada'] != 'S') {
    ...
    echo '<hr>';
    echo '<br>Paciente: <b>' . $af->getNrodoc() . ' - ' . $af->getNombre() . '</b><font color="#0066FF">' . $obs . '</font>';
