...
if (strlen(trim($_REQUEST[codigo])) == 6 and strlen(trim($_REQUEST[nombre])) > 0 and $l) {
  ...
  sleep(2);
  $obj=new cEfector;
  if ($obj->crear($codigo, $nombre, $usuario, $pass, $direccion, $nrocuit, $email, $id_especialidad, $id_tipoprestador, $fechamat, $matricula_nac, $matricula1, $parametro2, $parametro3, $nivel2)==true){
  }else{
