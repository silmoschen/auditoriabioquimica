...
if (strlen(trim($_REQUEST[nombre])) == 0) {
...
if (strlen(trim($_REQUEST[codigo])) == 6 and strlen(trim($_REQUEST[nombre])) > 0 and $l) {
    ...
    $obj = new cObSocial;
    if ($obj->crear($codigo, $nombre, strtoupper($factnbu), $bonos, $medicos_cab, $soportemag, $u, $p, $derivacion, $inc_leyenda, $leyenda, $ing_continuo, $incluye_ab, $aut_directa, $coseguro, $alta_paciente, $coseguro_mf, $nivel3, $tope_anual, $practicas_rechazadas, $orden_completa, $inactiva, $gen_nroautorizacion, $nivel2) == true) {
