    ...
    <head><title>Excluir Efectores de Obras Sociales</title>
        ...
        <script>
            ...
            function ControlOSS(){
                ...
                ajax.open('GET', './operaciones/paginador_profesionales_excluir.php?codos='+codos+'&aleatorio='+aleatorio);
           ...
           function chequear(idprof){
                ...
                ajax.open('GET', './operaciones/excluir_profesional.php?codos='+codos+'&idprof='+idprof+'&aleatorio='+aleatorio);
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        //mostrar resultados en esta capa
                        divLista.innerHTML = ajax.responseText
                ...
                <table width="550px" border="0">
                    <tr>
                        <td width="178px" align = "left">
                            Determinar Efectores Excluídos Fact.
                        </td>
                ...
                <table width="550px" border="0">
                    ...
                    <tr>
                        ...
                        <td width="330px" align = "left">
                            <?
                            include('operaciones/lista_os_ingordenes.php');
                            ?>
                        </td>
                    </tr>
                </table>    
