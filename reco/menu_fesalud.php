        ...
        <ul>
            ...
            <li><a href="">Consultas</a>
                <ul> <!--Ahora un submenu nivel 1 para Blogger con un par de opciones -->
                    ...
                    echo '<li><a href="/' . $ruta . '/consultar_histclinica_pac.php?trans=' . $trans . '"' . '>Consulta de Ordenes por Paciente</a></li>';
                    echo '<li><a href="/' . $ruta . '/exportar_detalle_ordenes_os.php?trans=' . $trans . '"' . '>Exportar Ordenes de Pacientes</a></li>';
