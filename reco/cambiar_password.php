    ...
    <head><title>Cambiar Password</title>
        ...
        <script>
            ...
            function MP(xpass2) {
                ...
                ajax=objetoAjax();
                ajax.open('GET', './operaciones/modificar_password.php?usuario='+usuario+'&pass='+xpass2+'&aleatorio='+aleatorio);
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==4) {
                        //mostrar resultados en esta capa
                    ...
                    <FIELDSET>
                        ...
                        <table width="300px" border="0" align="left">
                            <tr>
                                ...
                                <td>
                                    <input name="passactual" id="passactual" type="password" style="font-size: 10px;" maxlength="8" width="2" size="10" onkeypress="javascript: if(ValidarPassActual(event, passactual.value)) {nuevopass.focus()}; return true" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="nuevopass" id="nuevopass" type="password" disabled="true" style="font-size: 10px;" maxlength="8" width="2" size="10" onkeypress="javascript: if(ValidarNuevoPass(event, nuevopass.value)) {confirmapass.focus()}; return true" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="confirmapass" id="confirmapass" type="password" disabled="true" style="font-size: 10px;" maxlength="8" width="2" size="10" onkeypress="javascript: if(ValidarConfirmacion(event, confirmapass.value, nuevopass.value)) {registrar.focus()}; return true" />
                                </td>
                                <td width="100px" align="left"></td>
                            </tr>
