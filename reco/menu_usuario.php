...
<div style="margin:auto;width:550px;text-align:center; ">
    ...
    <div id="dhtmlgoodies_menu" align="left">
        <ul>
            ...
            <li><a href="">Ingresos</a>
                <ul> <!--Ahora un submenu nivel 1 para Blogger con un par de opciones -->
                    <?php
                    echo '<li><a href="/' . $ruta . '/ingresoordenesusuario.php?trans=' . $trans . '"' . '>Ingreso de Ordenes de Auditoría</a></li>';
                    echo '<li><a href="/' . $ruta . '/autorizacion_ordenesusuario.php?trans=' . $trans . '"' . '>Validar Ordenes Pendientes</a></li>';
                    echo '<li><a href="/' . $ruta . '/anular_ordenes.php">Anulación de Ordenes</a>';
        ...
        <li><a href="">Consultas</a>
            <ul> <!-- Ponemos un submen� nivel 1 para la opci�n trucos con 1 opci�n-->
                <?php
                echo '<li><a href="/' . $ruta . '/consulta_de_ordenes.php">Consulta e Impresión de Ordenes</a></li>';
                echo '<li><a href="/' . $ruta . '/consulta_de_ordenes_coseguro_iapos.php">Validación Bonos IAPOS</a></li>';
                ?>
        </li>
        </ul>
        ...
        <li><a href="">Perfil</a>
            <ul><!-- Ponemos una submen� nivel 1 para esta opcion Tutoriales-->
                <?php echo '<li><a href="/' . $ruta . '/cambiar_password.php">Cambiar Contraseña</a></li>'; ?>
            </ul>
        </li>
    ...
    if ($obj->getObs1() != '') {
        echo '<font size="2" style="color:green;">' . $obj->getObs1() . '</font><br/>';
    }
    ?>
