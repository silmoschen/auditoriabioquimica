        ...
        <script>
            ...
            function CargarReglas() {
                ...
                if (codos.length > 0) {
                    ...
                    var ajaxx = objetoAjax();
                    ajaxx.open('GET', './operaciones/obsocial_getReglas.php?codos=' + codos + '&aleatorio=' + aleatorio);
                    ajaxx.onreadystatechange = function () {
                        if (ajaxx.readyState == 4) {
                            //mostrar resultados en esta capa                                                        
                            var o = JSON.parse(ajaxx.responseText);
                            document.getElementById('reglaID').value = o.regla;
                        }
            ...
            function CargarLeyendas() {
                ...
                if (codos.length > 0) {
                    ...
                    var divley = document.getElementById('leyenda');


                    ajaxx = objetoAjax();
                    ajaxx.open('GET', './operaciones/obsocial_getNotificacionEstado.php?codos=' + codos + '&aleatorio=' + aleatorio);
                    ajaxx.onreadystatechange = function () {
                        if (ajaxx.readyState == 4) {
                            //mostrar resultados en esta capa                            
                            var o = JSON.parse(ajaxx.responseText);
                            ...
                            if (o == null) {
                                ...
                                divley.innerHTML = o[0].m1 + "<br/>" + o[0].m2 + "<br/>" + o[0].m3 + "<br/>" + o[0].m4 + "<br/>" + o[0].m5;
                            }
                        }
            ...
            function loadTopeRPC() {
                ...
                document.getElementById('divtoken1').style.display = 'none';
            ...
            function loadRPC() {
                ...
                ajax.onreadystatechange = function () {
                    if (ajax.readyState == 4) {
                        ...
                        // con token - 08/03/2023
                        //alert(ajax.responseText);

                        document.getElementById('req_token').value = '';
                        if (divrpc.value == 'ST') {
                            document.getElementById('a_rpc').value = 'S';
                            document.getElementById('req_token').value = 'S';
                            loadTopeRPC();
                            hidediv("divdoc");
                        }

                        //alert(document.getElementById('a_rpc').value);
                    }
                }
                ajax.send(null);
            }
            ...
            function CargarDeterminaciones() {
                ...
                divproc = document.getElementById('proceso');
                divproc.innerHTML = '<i>Procesando</i>';
                divDet1 = document.getElementById('RestriccionCodigos');
                divDet2 = document.getElementById('RestriccionCodigosJs');
                divDet1.innerHTML = '';
                divDet2.innerHTML = '';
                var codos = document.getElementById('listObsocial').value;
                ajaxdet1 = objetoAjax();
                ajaxdet1.open('GET', './operaciones/listar_obsocial_rest_codigos.php?codos=' + codos + '&aleatorio=' + aleatorio);
                ajaxdet1.onreadystatechange = function () {
                    if (ajaxdet1.readyState == 4) {
                        //mostrar resultados en esta capa                        
                        divproc.innerHTML = '';
                        divDet1.innerHTML = '';
                        divDet1.innerHTML = ajaxdet1.responseText;
                        /*
                         var jsonArray = ajaxdet1.responseText;
                         divDet2.innerHTML = jsonArray;  
                         */
                        ...
                        /*
                         ...
                         s += '<hr/><table>';
                         s += '<tr><td><b>Restricciones en el Ingreso de Codigos</b></td></tr>';  
                         s += '</table>';
                         
                         s += '<table>';
                         s += '<tr><td><b>Código</b></td><td><b>Contempla Código</b></td><td><b>Restricción</b></td></tr>';  
                         
                         dataArray.forEach(item => {
                         s += '<tr><td>' + item.codigo1 + '</td><td>' + item.codigo2 + '</td><td>' + item.observacion + '</td></tr>';
                         });
                ...
                if (confirm('¿ Seguro para Finalizar el Ingreso de Determinaciones ?')) {
                    ...
                    if (codigos.length > 0) {
                        ...
                        ajaxobs.onreadystatechange = function () {
                            ...
                            // 08/03/2023 - Ingreso de Token
                            if (document.getElementById('req_token').value == 'S') {
                                document.getElementById('divtoken1').style.display = 'block';
                                document.getElementById('__token1').value = '';
                                document.getElementById('__token1').focus();

                                // 13/09/2025 - Token Jerarquicos, requiere validación
                                if (document.getElementById('reglaID').value == 3) {
                                    document.getElementById('RegistrarOrdenAuditoria').disabled = true;
                                    document.getElementById('divtoken1').style.display = 'none';
                            ...
                            document.getElementById('RestriccionCodigos').innerHTML = '';
                            document.getElementById('RestriccionCodigosJs').innerHTML = '';
            ...
            function ArchivarOrden(xcodigos, medicocab) {
                ...
                //  Si por algun motivo, el botón está inahilitado, rechazamos la operación
                if (document.getElementById('RegistrarOrdenAuditoria').disabled)
                    return;
                ...
                // Validaciones - 01/09/2026
                if (validarTokenAmur() == false) {
                    return false;
                }               
                ...
                var diferida = 'N';
                var tokenrs1 = document.getElementById('__token1').value;
                var token2 = document.getElementById('__token').value;
                ...
                if (confirm('¿ Seguro para Registrar Orden ' + document.frmOrden.nrotrans.value + ' en Paciente Documento Nro. ' + document.frmOrden.nrodoc.value + ' ?')) {
                    ...
                    if (document.getElementById('a_rpc').value == 'S')
                        ajax.open('GET', './operaciones/insertar_orden_usuario_rpc.php?nrotrans=' + nrotrans + '&efector=' + usuario + '&fecha=' + fecha + '&codos=' + codos + '&idzona=' + '00' + '&nrodoc=' + nrodoc + '&idprof=' + idprof + '&observacion=' + observac + '&iddiag=' + iddiag + '&codigos=' + codigos + '&idperfil=' + idperfil + '&fepedido=' + fepedido + '&diferida=' + diferida + '&medicocab=' + medicocab + '&aleatorio=' + aleatorio + '&token=' + tokenrs1 + '&token2=' + token2);
                    ...
                    ajax.onreadystatechange = function () {
                        ...
                        document.frmOrden.nombremedico.disabled = false;
                        document.getElementById('listPerfil').disabled = false;
                        //document.getElementById('btntValidarToken').disabled = true;                                
            ...
            function CancelarImpresion() {
                ...
                //document.getElementById('btntValidarToken').disabled = false;                                
            ...
            function validarTokenAmur() {
                
                if (document.getElementById('reglaID').value == 4 && document.getElementById('req_token').value == 'S') {
                    
                    if (document.getElementById('__token1').value == '') {                    
                        alert('Requiere Token... !');
                        return false;
                    }
            ...
            function validarTokenJer() {
                var codos = document.getElementById('listObsocial').value;
                var nrodoc = document.getElementById('nrodoc').value;
                var tokenrs1 = document.getElementById('__token').value;


                // Token - JERARQUICOS: si está marcado, se valida antes de guardar
                if (document.getElementById('reglaID').value == 3 && document.getElementById('req_token').value == 'S') {
                    ...
                    var ajaxx = objetoAjax();
                    ajaxx.open('GET', './operaciones/validar_orden_token_rj_rpc.php?codos=' + codos + '&nrodoc=' + nrodoc + '&token=' + tokenrs1 + '&aleatorio=' + aleatorio1);
                    ajaxx.onreadystatechange = function () {
                        if (ajaxx.readyState == 4) {
                            //mostrar resultados en esta capa                            
                            var o = JSON.parse(ajaxx.responseText);
                            ...
                            if (o.length < 10) {
                                alert('TOKEN Invalido. Se Produjo un Error. ' + o.token);
                                return false;
                            }
                            ...
                            if (o.valido == false) {
                                ...
                                if (o.valido == true) {
                                    alert('TOKEN Correcto. Proceda a Registrar la Orden');
                                    document.getElementById('RegistrarOrdenAuditoria').disabled = false;
                                    //document.getElementById('btntValidarToken').disabled = true;
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <td align="right">Fecha:
                                    ...
                                    <!-- TOKEN GENÉRICO 08/03/2023 -->
                                    <div id="divtoken1" align="left">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        Token:&nbsp;&nbsp;<input type="text" id="__token1" />                                      
                                    </div>

                                    <div id="divtoken" align="center">
                                        <br/>
                                        <input type="hidden" id="__nroauditoria" />
                                        Token:
                                        <input type="text" onfocus="document.getElementById('RegistrarOrdenAuditoria').disabled = true" onblur="document.getElementById('RegistrarOrdenAuditoria').disabled = true" id="__token" /> 
                                        &nbsp;&nbsp;
                                        <input type="button" value="Validar" id="btntValidarToken" onclick="validarToken()" />                                                                                
                                        </br>                                        
                                    </div>
                                    ...
                                    <input type="hidden" name="req_token" id="reglaID" />
                                    ...
                                    <div id="RestriccionCodigos" align="left">

                                    </div>
                                    <div id="RestriccionCodigosJs">
                                    ...
                                    <script>
                                        ...
                                        document.getElementById('divtoken').style.display = 'none';
                                        document.getElementById('divtoken1').style.display = 'none';
                                        document.getElementById('RestriccionCodigosJs').style.display = 'none';
                                    </script>
